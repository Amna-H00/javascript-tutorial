"use strictly" // treat all js code as newer version 
// alert (3+3) //we are using nodejs not browser
console.log("Mahrosh kli")
//for standard readability documentation use ecma script (tc39.es ecmascript , mdn)
//two types od DT--> primitive (stored directly in variable)
// number = intergers
//bigint = big numbers like 1234556788n
//string = enclosed in ""
